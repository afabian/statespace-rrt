...
template <class T>
Vertex<T>::Vertex(T in): info(in), visited(false), num(0), low(0), path(){}


template <class T>
Vertex<T>::Vertex(const Vertex<T> & in): info(in.info), visited(in.visited), num(in.num), low(in.low), path(){}
...
template <class T>
T& Graph<T>::addVertex(const T &in) {
