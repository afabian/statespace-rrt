#ifndef MODULES_MOTION1DPOSITIONVELOCITYSINGLE_H
#define MODULES_MOTION1DPOSITIONVELOCITYSINGLE_H

#include "Motion1DInterfaceSingle.h"

class Motion1DPositionVelocitySingle : public Motion1DInterfaceSingle {
...
private:
    ...
    float get_vel_for_pos_mode(motion_state_s* current_state, motion_state_s* target_state);
    float get_time_remaining_for(motion_state_s* current_state, motion_state_s* target_state);
...
#endif //MODULES_MOTION1DPOSITIONVELOCITYSINGLE_H
