#ifndef MODULES_MOTION1DPOSITIONVELOCITYDOUBLE_H
#define MODULES_MOTION1DPOSITIONVELOCITYDOUBLE_H

#include "Motion1DInterfaceDouble.h"

class Motion1DPositionVelocityDouble : public Motion1DInterfaceDouble {
...
private:
    ...
    double get_vel_for_pos_mode(motion_state_s* current_state, motion_state_s* target_state);
    double get_time_remaining_for(motion_state_s* current_state, motion_state_s* target_state);
...
#endif //MODULES_MOTION1DPOSITIONVELOCITYDOUBLE_H
