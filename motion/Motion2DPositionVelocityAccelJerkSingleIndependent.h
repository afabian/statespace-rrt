#ifndef MODULES_MOTION2DPOSITIONVELOCITYACCELJERKSINGLEINDEPENDENT_H
#define MODULES_MOTION2DPOSITIONVELOCITYACCELJERKSINGLEINDEPENDENT_H

#include "Motion2DInterfaceSingle.h"
#include "Motion1DInterfaceSingle.h"
#include "Motion1DPositionVelocityAccelJerkSingle.h"

class Motion2DPositionVelocityAccelJerkSingleIndependent : public Motion2DInterfaceSingle {
...
private:
    ...
    Motion1DPositionVelocityAccelJerkSingle x;
    Motion1DPositionVelocityAccelJerkSingle y;

};

#endif //MODULES_MOTION2DPOSITIONVELOCITYACCELJERKSINGLEINDEPENDENT_H
