#ifndef MODULES_MOTION2DPOSITIONVELOCITYSINGLEINDEPENDENT_H
#define MODULES_MOTION2DPOSITIONVELOCITYSINGLEINDEPENDENT_H

#include "Motion2DInterfaceSingle.h"
#include "Motion1DInterfaceSingle.h"
#include "Motion1DPositionVelocitySingle.h"

class Motion2DPositionVelocitySingleIndependent : public Motion2DInterfaceSingle {
...
private:
    ...
    Motion1DPositionVelocitySingle x;
    Motion1DPositionVelocitySingle y;

};

#endif //MODULES_MOTION2DPOSITIONVELOCITYSINGLEINDEPENDENT_H
