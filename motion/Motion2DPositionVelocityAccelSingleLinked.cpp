#include "Motion2DPositionVelocityAccelSingleLinked.h"

using namespace std;

void Motion2DPositionVelocityAccelSingleLinked::configure_position_limits(float _limit_x_neg, float _limit_y_neg, float _limit_x_pos, float _limit_y_pos) {
...
void Motion2DPositionVelocityAccelSingleLinked::configure_velocity_limits(float _limit) {
...
void Motion2DPositionVelocityAccelSingleLinked::configure_acceleration_limits(float _limit) {
...
void Motion2DPositionVelocityAccelSingleLinked::configure_jerk_limits(float _limit) {
...
void Motion2DPositionVelocityAccelSingleLinked::configure_dt(float _dt) {
	x.configure_dt(_dt);
    y.configure_dt(_dt);
    xt.configure_dt(_dt);
    yt.configure_dt(_dt);
...
void Motion2DPositionVelocityAccelSingleLinked::jump_to(float _pos_x, float _pos_y, float _vel_x, float _vel_y, float _acc_x, float _acc_y) {
	xt.jump_to(_pos_x, _vel_x, _acc_x);
    yt.jump_to(_pos_y, _vel_y, _acc_y);
}

void Motion2DPositionVelocityAccelSingleLinked::set_arrival_time(float _arrival_time) {
    user_arrival_time = _arrival_time;
}

void Motion2DPositionVelocityAccelSingleLinked::set_target(float _pos_x, float _pos_y, float _vel_x, float _vel_y, float _acc_x, float _acc_y) {
    user.pos.x = _pos_x;
    user.pos.y = _pos_y;
    user.vel.x = _vel_x;
    user.vel.y = _vel_y;
...
void Motion2DPositionVelocityAccelSingleLinked::run_next_timestep() {
    ...
    // unless arrival time is now, then just return result from the fast solvers
...
void Motion2DPositionVelocityAccelSingleLinked::reset_state() {
    x.reset_state();
    y.reset_state();
    xt.reset_state();
    yt.reset_state();
...
Motion2DInterfaceSingle::coords_2d_s Motion2DPositionVelocityAccelSingleLinked::get_position() {
    coords_2d_s output;
...
Motion2DInterfaceSingle::coords_2d_s Motion2DPositionVelocityAccelSingleLinked::get_velocity() {
    coords_2d_s output;
...
Motion2DInterfaceSingle::coords_2d_s Motion2DPositionVelocityAccelSingleLinked::get_acceleration() {
    coords_2d_s output;
...
Motion2DInterfaceSingle::coords_2d_s Motion2DPositionVelocityAccelSingleLinked::get_jerk() {
    coords_2d_s output;
...
float Motion2DPositionVelocityAccelSingleLinked::get_time_remaining() {
    return cur_arrival_time;
}

Motion2DInterfaceSingle::motion_state_s Motion2DPositionVelocityAccelSingleLinked::get_state_at_time(float t) {
...
uint64_t Motion2DPositionVelocityAccelSingleLinked::get_error_code() {
    uint64_t output = yt.get_error_code().value << 32 | xt.get_error_code().value;
    return output;
}

Motion2DInterfaceSingle::coords_2d_s Motion2DPositionVelocityAccelSingleLinked::get_debug(int index) {
    return debug[index];
}
